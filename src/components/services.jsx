          ...
          <div className="grid gap-5 justify-center row-gap-8 lg:grid-cols-3">
            <div className="servicesCard">
              <div className="servicesImgContainer">
                <img
                  src="public\assets\heating-svgrepo-com.png"
                  alt=""
            ...
            <div className="servicesCard">
              <div className="servicesImgContainer">
                <img
                  src="public\assets\plumbing-pipe-svgrepo-com.png"
                  alt=""
            ...
            <div className="servicesCard">
              <div className="servicesImgContainer">
                <img
                  src="public\assets\house-temperature-smart-control.png"
                  alt=""
            ...
            <div className="servicesCard">
              <div className="servicesImgContainer">
                <img
                  src="public\assets\pngtree-gaz-boiler-heating-system-equipment-vector-icon-png-image_1804367.png"
                  alt=""
            ...
            <div className="servicesCard">
              <div className="servicesImgContainer">
                <img
                  src="public\assets\bathtub-bathroom-svgrepo-com.png"
                  alt=""
            ...
            <div className="servicesCard">
              <div className="servicesImgContainer">
                <img
                  src="public\assets\underfloor-heating-svgrepo-com.png"
                  alt=""
